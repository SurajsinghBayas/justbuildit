...
import {
  Briefcase, Plus, Loader2, FolderOpen, ArrowRight, Calendar
} from 'lucide-react';
      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        <div className="flex items-end justify-between border-b border-gray-200 pb-5">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">All initiatives in your organizations.</p>
          </div>
              ...
              <form onSubmit={handleCreateProject} className="space-y-4 mt-4">
                {orgs.length === 0 && (
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
                    ⚠️ You need to{' '}
                    <Link to="/organizations" className="font-semibold underline">create an organization</Link>{' '}
            ...
            {projects.length > 0 ? projects.map((p: any) => (
              ...
              >
                <CardContent className="p-5">
                  ...
                  <h3 className="font-semibold text-gray-900 truncate text-base">{p.name}</h3>
              ...
              <div className="col-span-3 py-20 text-center border border-dashed border-gray-200 rounded-xl">
                ...
                <p className="text-sm text-gray-400 mb-4">Create your first project to start tracking tasks.</p>
                {orgs.length === 0 && (
                  <Link to="/organizations">
                    <Button variant="outline" size="sm" className="mr-2">Create Organization First</Button>
                  </Link>
                )}
              </div>
            )}
